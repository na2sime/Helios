package fr.nassime.helios.postgres.integration;
...
/**
 * Integration tests for the complete Helios ORM functionality.
 */
class HeliosOrmIntegrationTest extends AbstractPostgreSQLTest {
